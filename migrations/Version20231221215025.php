 ...
 */
final class Version20231221215025 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE gas_station_price (id INT AUTO_INCREMENT NOT NULL, station_id INT NOT NULL, date DATE NOT NULL, type VARCHAR(15) NOT NULL, price DOUBLE PRECISION DEFAULT NULL, INDEX IDX_F635123D21BDB235 (station_id), INDEX IDX_F635123DAA9E377A (date), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
